...
class ATPSuite:
    ...
    def DTAL_4_2_5(self, run_time=10):
        ...
        with log_step("Installing MML Filter Rule using IPv4"):
            ...
            status_code, _ = utility.trigger_api("DTAL_4_2_5_IPv4", api_file=self.api_file, host=config['ALG']['IP_ADDRESS'])
            if status_code is None or status_code >= 400:
        ...
        with log_step("Installing Text based Filter Rule using IPv6"):
            ...
            status_code, _ = utility.trigger_api("DTAL_4_2_5_IPv6", api_file=self.api_file, host=config['ALG']['IP_ADDRESS_v6'])
            if status_code is None or status_code >= 400:
    ...
    def DTAL_4_2_6(self, run_time=10):
        ...
        with log_step("Installing Binary based Filter Rule using IPv4"):
            ...
            status_code, _ = utility.trigger_api("DTAL_4_2_6_IPv4", api_file=self.api_file, host=config['ALG']['IP_ADDRESS'])
            if status_code is None or status_code >= 400:
                logger.error("Filter rule installation failed using IPv4")
                raise AssertionError("Filter rule installation failed using IPv4")
            logger.info("Filter Rule installation successful using IPv4")
        ...
        with log_step("Installing Binary based Filter Rule using IPv6"):
            ...
            status_code, _ = utility.trigger_api("DTAL_4_2_6_IPv6", api_file=self.api_file, host=config['ALG']['IP_ADDRESS_v6'])
            if status_code is None or status_code >= 400:
                logger.error("Filter rule installation failed using IPv6")
                raise AssertionError("Filter rule installation failed using IPv6")
            logger.info("Filter Rule installation successful using IPv6")
    ...
    def DTAL_4_2_7(self, run_time=10):
        ...
        with log_step("Installing both MML and Binary based Filter Rule using IPv4"):
            ...
            status_code, _ = utility.trigger_api("DTAL_4_2_7_IPv4", api_file=self.api_file, host=config['ALG']['IP_ADDRESS'])
            if status_code is None or status_code >= 400:
                logger.error("Filter rule installation failed using IPv4")
                raise AssertionError("Filter rule installation failed using IPv4")
            logger.info("Filter Rule installation successful using IPv4")
        ...
        with log_step("Installing both MML and Binary based Filter Rule using IPv6"):
            ...
            status_code, _ = utility.trigger_api("DTAL_4_2_7_IPv6", api_file=self.api_file, host=config['ALG']['IP_ADDRESS_v6'])
            if status_code is None or status_code >= 400:
                logger.error("Filter rule installation failed using IPv6")
                raise AssertionError("Filter rule installation failed using IPv6")
            logger.info("Filter Rule installation successful using IPv6")
    ...
    def DTAL_4_2_8(self, run_time=10):
        # Install invalid filter rules
        with log_step("Install invalid filter rules"):
            status, _ = utility.trigger_api("DTAL_4_2_8_A", api_file=self.api_file)
            if status is None:
        ...
        with log_step("Install filter rules with missing fields"):
            status, _ = utility.trigger_api("DTAL_4_2_8_B", api_file=self.api_file)
            if status == None:
                logger.error(f"Api call failed")
                raise AssertionError(f"Api execution failed")
            logger.info("Installation api called successfully")
        ...
        with log_step("Install filter rules with invalid JSON/Schema"):
            status, _ = utility.trigger_api("DTAL_4_2_8_C", api_file=self.api_file)
            if status is None:
                logger.error(f"Api call failed")
                raise AssertionError(f"Api execution failed")
            logger.info("Installation api called successfully")
    ...
    ## Test case ID - DTAL_4_2_9
    def DTAL_4_2_9(self, run_time=10):
        ...
        with log_step("Validating NE logs"):
            logger.info(f"Validating NE simulator logs")
            ne_log_file = os.path.join(runner.report_dir, testcase_id, "NE_server.log")
            result = utility.search_string_in_file(ne_log_file, "Total connections: 2")
            assert result == 'PASS', f"Validation of test result failed."
            result = utility.search_string_in_file(ne_log_file, "Receiving data: 2")
            assert result == 'PASS', f"Validation of test result failed."
        ...
        with log_step("Validating NEM logs"):
            ...
            assert result == 'PASS', f"Validation of test result failed."
            result = utility.search_string_in_file(nem_log_file, "Messages sent: 2")
            assert result == 'PASS', f"Validation of test result failed."
    ...
    ## Test case ID - DTAL_4_2_10        
    def DTAL_4_2_10(self, run_time=10):
        testcase_id = "DTAL-4_2_10"
        start = time.time()
        ...
        with log_step("Validating NE logs"):
            ...
            result = utility.search_string_in_file(ne_log_file, "Total connections: 2")
            assert result == 'PASS', f"Validation of test result failed."
            result = utility.search_string_in_file(ne_log_file, "Receiving data: 0")
            assert result == 'PASS', f"Validation of test result failed."
    ...
    ## Test case ID - DTAL_4_2_11      
    def DTAL_4_2_11(self, run_time=10):
        testcase_id = "DTAL-4_2_11"
        start = time.time()
        ...
        with log_step("Validating NE logs"):
            ...
            result = utility.search_string_in_file(ne_log_file, "Total connections: 1")
            assert result == 'PASS', f"Validation of test result failed."
            result = utility.search_string_in_file(ne_log_file, "Receiving data: 1")
            assert result == 'PASS', f"Validation of test result failed."
    ...
    ## Test case ID - DTAL_4_2_12
    def DTAL_4_2_12(self, run_time=10):
        testcase_id = "DTAL-4_2_12"
        start = time.time()
    ...
    ## Test case ID - DTAL_4_2_13
    def DTAL_4_2_13(self, run_time=10):
        testcase_id = "DTAL-4_2_13"
        start = time.time()
    ...
    ## Test case ID - DTAL_4_2_14
    def DTAL_4_2_14(self, run_time=10):
        testcase_id = "DTAL-4_2_14"
        start = time.time()
    ...
    ## Test case ID - DTAL_4_2_15
    def DTAL_4_2_15(self, run_time=10):
        testcase_id = "DTAL-4_2_15"
        start = time.time()
    ...
    def DTAL_4_3_4(self, run_time):
        testcase_id = "DTAL-4_3_4"
        start = time.time()
