...
class TestSuite:
    ...
    # ## Test case ID - DTAL_302
    # def DTAL_302(self, ne_config_file=None, nem_config_file=None, run_time=10):
    #     testcase_id = "DTAL-302"
    #     testcase_description = "Execution of Binary command - 5 over IPv4 connection"
    #     utility.start_testcase(testcase_id, testcase_description)
    #     logger.info(f"[{testcase_id}] - {testcase_description}")
    #     start = time.time()

    #     try:
    #         # Starting NE simulator
    #         with utility.log_step("Starting NE simulator"):
    #             ne_server = utility.start_NE(testcase_id, runner.report_dir, ne_config_file)
    #             if ne_server is None:
    #                 assert False, "NE server failed to start"

    #         # Starting NEM simulator
    #         with utility.log_step("Starting NEM simulator"):
    #             nem_server = utility.start_NEM(testcase_id, runner.report_dir, nem_config_file)
    #             if nem_server is None:
    #                 assert False, "NEM server failed to start"
    #             logger.info(f"Waiting for {run_time} seconds for simulator to complete the operation")
    #             time.sleep(run_time)
    ...
    #         # Stopping NEM simulator
    #         with utility.log_step("Stopping NE simulator "):
    #             nem_server.stop_server()
    #             # Ensure NEM simulator has time to stop
    #             time.sleep(1)
            
    #         # Stopping NE simulator
    #         with utility.log_step("Stopping NEM simulator"):
    #             ne_server.stop_server()
    #             # Ensure NE simulator has time to stop
    #             time.sleep(1)
    ...
    #         end = time.time()
    #         timeTaken = end - start
    #         with utility.log_step("Collecting ALG logs"):
    #             utility.get_ALG_logs(testcase_id, timeTaken)

    #         #simulator_val1 = int(run_time) - 2
    #         with utility.log_step("Validating NE logs"):
    #             logger.info(f"Validating NE simulator logs")
    #             ne_log_file = os.path.join(runner.report_dir, testcase_id, "NE_server.log")
    #             #result = utility.search_string_in_file(ne_log_file, "Total connections: 1", int(simulator_val1))
    #             result = utility.search_string_in_file(ne_log_file, "Total connections: 1")
    ...
    #         with utility.log_step("Validating NEM logs"):
    #             logger.info(f"Validating NEM simulator logs")
    #             nem_log_file = os.path.join(runner.report_dir, testcase_id, "NEM_server.log")
    #             result = utility.search_string_in_file(nem_log_file, "Established 1 connections")
    #             assert result == 'PASS', f"Validation of test result failed."

    #         with utility.log_step("Validating ALG logs"):
    #             logger.info(f"Validating ALG logs")
    #             alg_log_file = os.path.join(runner.report_dir, testcase_id, "ALG.log")
    #             result = utility.search_string_in_file(alg_log_file, "TLS handshake with upstream MML port successfull")
    #             assert result == 'PASS', f"Validation of test result failed."
    ...
    #     finally:
    #         utility.end_testcase(testcase_id)

    # ## Test case ID - DTAL_303
    # def DTAL_303(self, ne_config_file=None, nem_config_file=None, run_time=10):
    #     testcase_id = "DTAL-303"
    #     testcase_description = "Execution of Binary CmdCode-257, subCmd:61572, subCmd:parameter- TRCTYPE over IPv4 connection"
    #     utility.start_testcase(testcase_id, testcase_description)
    #     logger.info(f"[{testcase_id}] - {testcase_description}")
    #     start = time.time()
    ...
    # def DTAL_310(self, ne_config_file=None, nem_config_file=None, run_time=10):
    #     testcase_id = "DTAL-310"
    #     testcase_description = "Execution of MML command with FTP upload command in passive mode over IPv4 connection"
    #     utility.start_testcase(testcase_id, testcase_description)
    #     logger.info(f"[{testcase_id}] - {testcase_description}")
    #     start = time.time()
    ...
    #     testcase_description = "Execution of MML command with FTP upload command in Extended Passive mode over IPv6 connection"
    #     utility.start_testcase(testcase_id, testcase_description)
    #     logger.info(f"[{testcase_id}] - {testcase_description}")
    #     start = time.time()
    ...
    #     testcase_description = "Updating Filter Rule runtime for MML rules only and running MML command over IPv4 connection"
    #     utility.start_testcase(testcase_id, testcase_description)
    #     logger.info(f"[{testcase_id}] - {testcase_description}")
    #     start = time.time()

    #     try:
    #         # Checking current filter Rules
    #         with utility.log_step("Initial Filter Rules"):
    #             utility.get_filter_rules_and_validate(api_key="get_filter_rules", expected_values_key="precondition_rule")

    #         time.sleep(1)
    #         with utility.log_step("Update Filter Rules - MML"):
    ...
    #         with utility.log_step("Validating updated Filter Rules"):
    #             # Checking current Filter-Rule setting after update
    ...
    #         with utility.log_step("Revert Goden Config Filter Rules"):
    ...
    #     testcase_description = "Updating Filter Rule runtime for Binary rules only and running Binary command over IPv4 connection"
    #     utility.start_testcase(testcase_id, testcase_description)
    #     logger.info(f"[{testcase_id}] - {testcase_description}")
    #     start = time.time()
    ...
    #         time.sleep(1)
    #         with utility.log_step("Update Filter Rules - Binary"):
    #             # Installing New Filter-Rule
    #             logger.info("Updating filter rule as per test case")
    ...
    #     testcase_description = "Getting Metrics from ALG and validating for some static fields"
    #     utility.start_testcase(testcase_id, testcase_description)
    #     logger.info(f"[{testcase_id}] - {testcase_description}")
    #     start = time.time()
    ...
    #         with utility.log_step("Retrieving Metrics"):
    ...
    #         with utility.log_step("Parsing Metrics"):
    #             metrics_dict = utility.parse_metrics_to_dict(body)
  
    #         with utility.log_step("Getting Metrics in Tablular format"):
    ...
    # def DTAL_17(self):
    #     testcase_id = "DTAL-17"
    #     testcase_description = "Validate Installation of invalid filter rules"
    #     utility.start_testcase(testcase_id, testcase_description)
    #     logger.info(f"[Start] {testcase_id}: Validate Installation of invalid filter rules")

    #     try:
    #         with utility.log_step("Install invalid filter rules"):
    ...
    #             logger.info("[Success] Installation api called successfully")

    #         with utility.log_step("Validate response failure"):
    #             if status != 422:
    #                 logger.error(f"[Failure] Expected status 422, got {status}")
    #                 raise AssertionError(f"Expected status 422, got {status}")

    #             logger.info("[Success] Response status code is 422 as expected")

    #     finally:
    #         utility.end_testcase(testcase_id)
    #         logger.info(f"[End] {testcase_id}: Validate Installation of invalid filter rules")


    # def DTAL_18(self):
    #     testcase_id = "DTAL-18"
    #     testcase_description = "Validate Installation of filter rules with missing fields"
    #     utility.start_testcase(testcase_id, testcase_description)
    #     logger.info(f"[Start] {testcase_id}: Validate Installation of filter rules with missing fields")

    #     try:
    #         with utility.log_step("Install filter rules with missing fields"):
    ...
    #     finally:
    #         utility.end_testcase(testcase_id)
    #         logger.info(f"[End] {testcase_id}: Validate Installation of filter rules with missing fields")


    # def DTAL_19(self):
    #     testcase_id = "DTAL-19"
    #     testcase_description = "Validate Installation of filter rules with invalid JSON/Schema"
    #     utility.start_testcase(testcase_id, testcase_description)
    #     logger.info(f"[Start] {testcase_id}: Validate Installation of filter rules with invalid JSON/Schema")

    #     try:
    #         with utility.log_step("Install filter rules with invalid JSON/Schema"):
    ...
    #         with utility.log_step("Validate response failure"):
    #             if status != 415:
    #                 logger.error(f"[Failure] Expected status 415, got {status}")
    #                 raise AssertionError(f"Expected status 415, got {status}")

    #             logger.info("[Success] Response status code is 415 as expected")

    #     finally:
    #         utility.end_testcase(testcase_id)
    #         logger.info(f"[End] {testcase_id}: Validate Installation of filter rules with invalid JSON/Schema")